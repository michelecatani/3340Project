...
export default function home() {
  ...
  return (
    <Container>
      {/* Meta Tags */}
      <Head>
        <title>NeoBay Home</title>
        <meta charset="UTF-8" />
        <meta
          name="keywords"
          content="home, index, team, react, nextjs, NeoBay, Auction, Comp3340, 3340"
        />
        <meta name="author" content="The Squad 2022" />
        <meta
          name="description"
          content="This is the hompage and main entry point for our NeoBay auction site for COMP3340 World Wide Web Info System Dev"
        />
      ...
      <Container align="center">
        ...
        <h2>Auctions!</h2>
        <h4>
          <i>Where treasures are found</i>
        </h4>
        <hr></hr>
        <p>Check out our featured auctions below:</p>
        <hr></hr>
        <h2>Expand your Technology!</h2>
        <Button class="homeitem" variant="outlined" href="#contained-buttons">
          TECHNOLOGY 1
        </Button>
        <Button class="homeitem" variant="outlined" href="#contained-buttons">
          TECHNOLOGY 2
